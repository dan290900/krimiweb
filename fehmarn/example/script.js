document.addEventListener("DOMContentLoaded", () => {
  const roundConfig = {
    runde1: { password: "KRIMI", label: "Runde 1" },
    runde2: { password: "DINNER", label: "Runde 2" },
    runde3: { password: "MORD", label: "Runde 3" },
  };

  const storagePrefix = "krimi:max-mustermann-example:";
